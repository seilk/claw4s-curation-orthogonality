...
Approximate $1\sigma$ at $n=500$ from binomial-like metric variance is $\pm 0.018$ (Distinct-2) and $\pm 0.020$ (Self-BLEU), so these cross-subset gaps exceed single-seed uncertainty by $\sim 3\times$.
